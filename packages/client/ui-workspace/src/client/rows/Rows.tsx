...
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDelete, drag, flat = false, t }: {
  ...
  /** Delete this session (row menu action; opens a confirmation dialog). */
  ...
  const sessionMenuItems = [
    ...
    // Delete is destructive (tombstone + detach) and opens a confirmation
    // dialog; it sits last and uses the danger style to signal irreversibility.
