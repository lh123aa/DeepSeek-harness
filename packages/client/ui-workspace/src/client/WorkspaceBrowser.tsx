...
> & {
  ...
  /** Delete a session (row menu action; opens the browser-owned confirmation dialog). */
...
export function WorkspaceBrowser({
  ...
  // Session delete dialog: destructive (tombstone archive + detach) and
  // opens a confirmation dialog so accidental deletion cannot happen.
