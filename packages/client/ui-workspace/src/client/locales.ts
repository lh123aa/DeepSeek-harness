...
export const zh = {
  ...
  'delete.session.desc': '将把「{name}」从侧边栏永久移除，其日志仍保留在磁盘上。此操作不可在界面撤销。',
  'delete.session.confirm': '删除对话',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently removes "{name}" from the sidebar. Its log stays on disk. This cannot be undone from the interface.',
  'delete.session.confirm': 'Delete conversation',
